      ...
      <div className="bg-white rounded-xl overflow-hidden shadow-lg" style={{ fontFamily: "'Georgia', serif" }}>
        ...
        {days.map(([date, events], dayIdx) => {
          ...
          return (<div key={date}>
            ...
            <div className="px-10 py-3">{events.map((ev, i) => { const color = TC[ev.type] || '#143F77'; const bg = TBG[ev.type] || '#f0f5ff'; const cl = canEdit && ev.section && ev.itemId; return (<div key={i}>
              ...
              {/* Hotel Photos on Client Itinerary */}
