...
import { PrintPageHeader, PrintPageFooter } from './PrintHeaderFooter';
...
// 50 TEMPLATES across 10 LAYOUT STRUCTURES
...
const TEMPLATES = [
  ...
  // RESORT (5) - NEW: Warm tropical feel, full images on hotel cards
  T('rs-1','Resort Tropical','resort','linear-gradient(135deg,#065f46,#34d399)',{primaryColor:'#065f46',accentColor:'#34d399',fontFamily:'clean',layoutStyle:'resort'}),
  T('rs-2','Resort Maldives','resort','linear-gradient(135deg,#0e7490,#67e8f9)',{primaryColor:'#0e7490',accentColor:'#67e8f9',fontFamily:'elegant',layoutStyle:'resort'}),
  // PASSPORT (3) - NEW: Passport stamp style, bold stamps and borders
  T('pp-1','Passport Navy','passport','linear-gradient(135deg,#1e3a5f,#60a5fa)',{primaryColor:'#1e3a5f',accentColor:'#60a5fa',fontFamily:'mono',layoutStyle:'passport'}),
  T('pp-2','Passport Wine','passport','linear-gradient(135deg,#581c87,#c084fc)',{primaryColor:'#581c87',accentColor:'#c084fc',fontFamily:'mono',layoutStyle:'passport'}),
  T('pp-3','Passport Green','passport','linear-gradient(135deg,#14532d,#86efac)',{primaryColor:'#14532d',accentColor:'#86efac',fontFamily:'mono',layoutStyle:'passport'}),
  // POSTCARD (5) - NEW: Rounded image cards, handwriting feel
  T('pc-1','Postcard Blue','postcard','linear-gradient(135deg,#1d4ed8,#93c5fd)',{primaryColor:'#1d4ed8',accentColor:'#93c5fd',fontFamily:'serif',layoutStyle:'postcard'}),
  T('pc-2','Postcard Warm','postcard','linear-gradient(135deg,#b45309,#fde68a)',{primaryColor:'#b45309',accentColor:'#fde68a',fontFamily:'serif',layoutStyle:'postcard'}),
  T('pc-3','Postcard Rose','postcard','linear-gradient(135deg,#be185d,#fbcfe8)',{primaryColor:'#be185d',accentColor:'#fbcfe8',fontFamily:'elegant',layoutStyle:'postcard'}),
];

const CATS: Record<string, { label: string; images: string[] }> = {
  destinations: { label: 'Destinations', images: ['https://images.unsplash.com/photo-1552832230-c0197dd311b5?w=400','https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=400','https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=400','https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=400','https://images.unsplash.com/photo-1533105079780-92b9be482077?w=400','https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=400','https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=400','https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?w=400'] },
  hotels: { label: 'Hotels', images: ['https://images.unsplash.com/photo-1566073771259-6a8506099945?w=400','https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=400','https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?w=400','https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=400','https://images.unsplash.com/photo-1584132967334-10e028bd69f7?w=400','https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=400','https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=400','https://images.unsplash.com/photo-1590490360182-c33d955e4819?w=400'] },
  airports: { label: 'Airports', images: ['https://images.unsplash.com/photo-1436491865332-7a61a109db05?w=400','https://images.unsplash.com/photo-1569154941061-e231b4725ef1?w=400','https://images.unsplash.com/photo-1556388158-158ea5ccacbd?w=400','https://images.unsplash.com/photo-1474302770737-173ee21bab63?w=400','https://images.unsplash.com/photo-1583863788434-e58a36330cf0?w=400','https://images.unsplash.com/photo-1529074963764-98f45c47344b?w=400','https://images.unsplash.com/photo-1517479149777-5f3b1511d5ad?w=400','https://images.unsplash.com/photo-1544016768-982d1554f0b9?w=400'] },
  beach: { label: 'Beach', images: ['https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=400','https://images.unsplash.com/photo-1519046904884-53103b34b206?w=400','https://images.unsplash.com/photo-1509233725247-49e657c54213?w=400','https://images.unsplash.com/photo-1476673160081-cf065607f449?w=400','https://images.unsplash.com/photo-1514282401047-d79a71a590e8?w=400','https://images.unsplash.com/photo-1548574505-5e239809ee19?w=400','https://images.unsplash.com/photo-1510097467424-192d713fd8b2?w=400','https://images.unsplash.com/photo-1506929562872-bb421503ef21?w=400'] },
  mountains: { label: 'Mountains', images: ['https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=400','https://images.unsplash.com/photo-1486870591958-9b9d0d1dda99?w=400','https://images.unsplash.com/photo-1454496522488-7a8e488e8606?w=400','https://images.unsplash.com/photo-1519681393784-d120267933ba?w=400','https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=400','https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=400','https://images.unsplash.com/photo-1527668752968-14dc70a27c95?w=400','https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400'] },
  cities: { label: 'Cities', images: ['https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=400','https://images.unsplash.com/photo-1480714378408-67cf0d13bc1b?w=400','https://images.unsplash.com/photo-1519501025264-65ba15a82390?w=400','https://images.unsplash.com/photo-1444723121867-7a241cacace9?w=400','https://images.unsplash.com/photo-1534430480872-3498386e7856?w=400','https://images.unsplash.com/photo-1514214246283-d427a95c5d2f?w=400','https://images.unsplash.com/photo-1534190239940-9ba8944ea261?w=400','https://images.unsplash.com/photo-1501594907352-04cda38ebc29?w=400'] },
  luxury: { label: 'Luxury', images: ['https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=400','https://images.unsplash.com/photo-1584132967334-10e028bd69f7?w=400','https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=400','https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=400','https://images.unsplash.com/photo-1566073771259-6a8506099945?w=400','https://images.unsplash.com/photo-1590490360182-c33d955e4819?w=400','https://images.unsplash.com/photo-1578683010236-d716f9a3f461?w=400','https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=400'] },
  food: { label: 'Food', images: ['https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400','https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400','https://images.unsplash.com/photo-1551218808-94e220e084d2?w=400','https://images.unsplash.com/photo-1476224203421-9ac39bcb3327?w=400','https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=400','https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=400','https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?w=400','https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=400'] },
  travel: { label: 'Travel', images: ['https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=400','https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?w=400','https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=400','https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=400','https://images.unsplash.com/photo-1530789253388-582c481c54b0?w=400','https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=400','https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=400','https://images.unsplash.com/photo-1527631746610-bca00a040d60?w=400'] },
  attractions: { label: 'Attractions', images: ['https://images.unsplash.com/photo-1552832230-c0197dd311b5?w=400','https://images.unsplash.com/photo-1523906834658-6e24ef2386f9?w=400','https://images.unsplash.com/photo-1583422409516-2895a77efded?w=400','https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=400','https://images.unsplash.com/photo-1541849546-216549ae216d?w=400','https://images.unsplash.com/photo-1516550893923-42d28e5677af?w=400','https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?w=400','https://images.unsplash.com/photo-1548786811-dd6e453ccca7?w=400'] },
};
...
function ImagePickerModal({ imageKey, currentUrl, onSelect, onClose }: { imageKey: string; currentUrl: string; onSelect: (url: string) => void; onClose: () => void }) {
  ...
  const search = () => { if (!query.trim()) return; setCat(''); const r: string[] = []; for (let i = 0; i < 8; i++) r.push(`https://source.unsplash.com/600x400/?${encodeURIComponent(query.trim())}&sig=${i}`); setResults(r); };
  const imgs = cat ? CATS[cat]?.images || [] : results;
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4" onClick={onClose}>
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[85vh] overflow-hidden flex flex-col" onClick={e => e.stopPropagation()}>
        ...
        <div className="px-5 py-3 border-b flex-shrink-0" style={{ borderColor: GHL.border }}><div className="flex gap-2"><input value={query} onChange={e => setQuery(e.target.value)} onKeyDown={e => e.key === 'Enter' && search()} placeholder="Search... (rome, airport, luxury hotel, beach)" className="flex-1 px-3 py-2 border rounded-lg text-sm" style={{ borderColor: GHL.border }} /><button onClick={search} className="px-4 py-2 text-sm font-semibold text-white rounded-lg" style={{ background: GHL.accent }}>Search</button></div></div>
        ...
        <div className="flex-1 overflow-y-auto p-4">{imgs.length > 0 ? (<div className="grid grid-cols-4 gap-2">{imgs.map((u, i) => (<button key={u + i} onClick={() => { onSelect(u.replace('w=400', 'w=1200')); onClose(); }} className="aspect-[4/3] rounded-lg overflow-hidden border-2 hover:border-blue-500 hover:shadow-lg transition-all" style={{ borderColor: 'transparent' }}><img src={u} alt="" className="w-full h-full object-cover" loading="lazy" /></button>))}</div>) : (<div className="text-center py-12"><p className="text-sm font-semibold" style={{ color: GHL.muted }}>Search or pick a category</p></div>)}</div>
      </div>
    </div>
  );
}
