...
export const FLIGHT_FIELDS: FormField[] = [
  ...
  { key: 'fromCity', label: 'Departure City', placeholder: 'Cancun', location: true },
  { key: 'to', label: 'Arrival Airport Code', placeholder: 'EWR' },
  { key: 'toCity', label: 'Arrival City', placeholder: 'Newark', location: true },
...
export const INSURANCE_FIELDS: FormField[] = [
  ...
  { key: 'coverage', label: 'Coverage', type: 'select', options: ['Comprehensive', 'Basic', 'Adventure', 'Medical Only', 'Trip Cancellation', 'Other'] },
...
export const DAVENING_FIELDS: FormField[] = [
  ...
  { key: 'shachris', label: 'Shachris', placeholder: '6:30, 7:00, 8:00 AM' },
  { key: 'mincha', label: 'Mincha', placeholder: '1:30 PM, Sunset -20min' },
  { key: 'mariv', label: 'Maariv', placeholder: 'After sunset, 9:00 PM' },
