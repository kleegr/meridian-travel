...
export interface Flight { id: number; from: string; to: string; airline: string; flightNo: string; departure: string; arrival: string; pnr: string; source: string; supplier: string; cost: number; sell: number; notes: string; }
...
export interface Transport { id: number; type: string; carType: string; provider: string; pickup: string; dropoff: string; pickupDateTime: string; ref: string; source: string; cost: number; sell: number; notes: string; }
...
export interface Itinerary {
  id: number; title: string; client: string; agent: string; startDate: string; endDate: string; destination: string; status: string; passengers: number; tags: string[]; notes: string; created: string;
  passengerList: Passenger[]; flights: Flight[]; hotels: Hotel[]; transport: Transport[]; attractions: Attraction[]; insurance: Insurance[]; carRentals: CarRental[]; deposits: number; checklist: CheckItem[];
}
